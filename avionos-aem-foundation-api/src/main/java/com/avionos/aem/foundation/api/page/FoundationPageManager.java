...
public interface FoundationPageManager extends PageManager {
     ...
     */
    @Override
    FoundationPage copy(Page page, String destination, String beforeName, boolean shallow, boolean resolveConflict)
        throws WCMException;
     ...
     */
    @Override
    FoundationPage create(String parentPath, String pageName, String template, String title) throws WCMException;
     ...
     */
    @Override
    FoundationPage create(String parentPath, String pageName, String template, String title, boolean autoSave)
        throws WCMException;
     ...
     */
    @Override
    FoundationPage move(Page page, String destination, String beforeName, boolean shallow, boolean resolveConflict,
