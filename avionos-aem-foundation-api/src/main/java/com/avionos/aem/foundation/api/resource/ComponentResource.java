...
public interface ComponentResource extends Linkable, Accessible, Inheritable, Traversable<ComponentResource> {
     ...
     * path will be removed from the identifier, since the relative path of a component resource is always unique for a
     * page.
     *
     * @return unique ID
     */
    ...
    /**
     * Get the component resource for the resource at the given path relative to the current resource.
     *
     ...
     * @return list of component resources that meet the predicate criteria or empty list if none exist
     */
     ...
     * @return list of component resources below the specified relative path or empty list if none exist
     */
     ...
     * @return list of component resources matching the given resource type below the specified relative path or empty
     * list if none exist
     */
     ...
     * @param relativePath relative path to parent of desired resources
     * @param predicate predicate used to filter resources
     * @return list of component resources that meet the predicate criteria below the specified relative path or empty
     * list if none exist
     */
