...
public final class ReferenceInjector extends AbstractComponentResourceInjector
    ...
    public Object getValue(final ComponentResource componentResource, final String name, final Type declaredType,
        ...
        if (annotation != null) {
            final List<String> references = annotation.inherit() ? componentResource.getAsListInherited(name,
                String.class) : componentResource.getAsList(name, String.class);
    ...
    private List<Object> getReferencedObjects(final ComponentResource componentResource, final Type declaredType,
        ...
        for (final String reference : references) {
            final Resource referencedResource = reference.startsWith("/") ? resourceResolver.getResource(
                reference) : resourceResolver.getResource(componentResource.getResource(), reference);
